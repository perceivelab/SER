...
def store_masked_loaders(train_dataset: Dataset, test_dataset: Dataset,
    ...
    if hasattr(train_dataset, 'data_path'):
        train_dataset.data_path = np.array(train_dataset.data_path)[train_mask]
    if hasattr(test_dataset, 'data_path'):
        test_dataset.data_path = np.array(test_dataset.data_path)[test_mask]
