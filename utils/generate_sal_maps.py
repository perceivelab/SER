...
from utils.training import generate_saliency_maps
import time
...
def main(args=None):
    ...
    if isinstance(model, CLModel2Branches):
        generate_saliency_maps(model, dataset, args)
    else:
       raise NotImplementedError('generate_sal_maps function requires a Continual_SAL_Dastaset and a Saliency-guided Model')
